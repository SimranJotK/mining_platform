...
import com.cryptomining.platform.gateway.ApiGatewayFilter;
import com.cryptomining.platform.security.JwtAuthenticationFilter;
import com.cryptomining.platform.security.RateLimitFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/admin/**").hasAnyRole("ADMIN", "CREATOR")
